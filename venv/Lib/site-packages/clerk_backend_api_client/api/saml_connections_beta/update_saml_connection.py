...
def sync_detailed(
    ...
    *,
    ...
    r"""Update a SAML Connection
     ...
     Updates the SAML Connection whose ID matches the provided `id` in the path. <br/> Refer to <a
    href=\"https://clerk.com/docs/authentication/saml-at-clerk#saml-at-clerk-beta\">Clerk SAML
